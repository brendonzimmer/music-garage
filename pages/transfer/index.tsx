  ...
  return (
    <>
      ...
      <div className="m-3 text-white font-bold space-y-2">
        ...
        <div id="disabler" className={`duration-700 ease-in-out space-y-2 ${!musicUserToken ? "opacity-50" : ""}`}>
          <div className="opacity-60 flex space-x-1">
          ...
          <Link href="/api/login">
            <button
              ...
              className="bg-white bg-opacity-30 px-3 py-2 rounded-md w-full text-black text-opacity-60 font-semibold transition duration-1000 ease-in-out"
            >
              Log in
            </button>
          </Link>
