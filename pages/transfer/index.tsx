...
const Transfer: React.FC<{ devToken: string }> = ({ devToken }) => {
  ...
  return (
    <>
      {Head}
      <div className="sm:grid sm:place-items-center sm:h-screen">
        <div className="m-3 text-white font-bold space-y-2">
          <div className="bg-white/20 py-2 px-3 rounded-md">
            ...
            <p className="text-lg text-black tracking-tight opacity-60 font-semibold leading-tight lg:my-3 lg:text-3xl lg:tracking-normal">
